...
Replace this sentence with your exact machine details before submission: the experiment was run on Windows 11 using Python 3 on a laptop/desktop with \texttt{[CPU]} and \texttt{[RAM]}.
...
The source code for this project is available at: \url{https://github.com/Maxbatan/fol-proof-search-3806ict}.
